...
# Compile circuits
circom zk/circuits/albertmerkle.circom -o zk/ --r1cs --wasm
#circom zk/circuits/shot.circom -o zk/ --r1cs --wasm

#Setup
yarn snarkjs groth16 setup zk/albertmerkle.r1cs zk/ptau/pot15_final.ptau zk/zkey/albertmerkle_final.zkey
#yarn snarkjs groth16 setup zk/shot.r1cs zk/ptau/pot15_final.ptau zk/zkey/shot_final.zkey

# # Generate reference zkey
yarn snarkjs zkey new zk/albertmerkle.r1cs zk/ptau/pot15_final.ptau zk/zkey/albertmerkle_0000.zkey
...
yarn snarkjs zkey contribute zk/zkey/albertmerkle_0000.zkey zk/zkey/albertmerkle_0001.zkey \
...
yarn snarkjs zkey contribute zk/zkey/albertmerkle_0001.zkey zk/zkey/albertmerkle_0002.zkey \
...
yarn snarkjs zkey contribute zk/zkey/albertmerkle_0002.zkey zk/zkey/albertmerkle_0003.zkey \
...
# #  Verify zkey
yarn snarkjs zkey verify zk/albertmerkle.r1cs zk/ptau/pot15_final.ptau zk/zkey/albertmerkle_0003.zkey
#yarn snarkjs zkey verify zk/shot.r1cs zk/ptau/pot15_final.ptau zk/zkey/shot_0003.zkey

# # Apply random beacon as before
yarn snarkjs zkey beacon zk/zkey/albertmerkle_0003.zkey zk/zkey/albertmerkle_final.zkey \
...
yarn snarkjs zkey verify zk/albertmerkle.r1cs zk/ptau/pot15_final.ptau zk/zkey/albertmerkle_final.zkey
#yarn snarkjs zkey verify zk/shot.r1cs zk/ptau/pot15_final.ptau zk/zkey/shot_final.zkey

# # Export verification key
yarn snarkjs zkey export verificationkey zk/zkey/board_final.zkey zk/albertmerkle_verification_key.json
...
yarn snarkjs zkey export solidityverifier zk/zkey/albertmerkle_final.zkey contracts/albertmerkleVerifier.sol
